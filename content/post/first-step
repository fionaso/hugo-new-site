Writing your first JavaScript code: a little refresh
...
JavaScript – this is what interacts with your users.
...
-	On the contrary, a server-side code runs on the web server meaning before the page is downloaded.
